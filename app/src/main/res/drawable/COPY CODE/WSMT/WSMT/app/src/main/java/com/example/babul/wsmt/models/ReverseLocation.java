...
public class ReverseLocation implements Parcelable {
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    @SerializedName("alternatebom")
    @Expose
    private ReverseAlter reverseAlter;

    public ReverseLocation() {

    }

    private ReverseLocation(Parcel in) {
        if (in.readByte() == 0) {
            id = null;
        } else {
            id = in.readInt();
        ...
        reverseAlter = in.readParcelable(ReverseAlter.class.getClassLoader());
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(reverseAlter, flags);
    }
    ...
    public static final Creator<ReverseLocation> CREATOR = new Creator<ReverseLocation>() {
        @Override
        public ReverseLocation createFromParcel(Parcel in) {
            return new ReverseLocation(in);
        }

        @Override
        public ReverseLocation[] newArray(int size) {
            return new ReverseLocation[size];
        }
    };
    ...
    public ReverseAlter getReverseAlter() {
        return reverseAlter;
    }

    public void setReverseAlter(ReverseAlter reverseAlter) {
        this.reverseAlter = reverseAlter;
    }
}
